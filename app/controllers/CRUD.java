...
//import play.modules.crud.annotations.Exclude;
//import play.modules.crud.annotations.For;
//import play.modules.crud.annotations.Hidden;
    ...
    public static class ObjectType implements Comparable<ObjectType> {
        ...
        public static class ObjectField {
            ...
            public ObjectField(Model.Property property) {
                ...
                if (field.isAnnotationPresent(Hidden.class) || field.isAnnotationPresent(play.modules.crud.annotations.Hidden.class)) {
                    type = "hidden";
                }
                if (field.isAnnotationPresent(Exclude.class) || field.isAnnotationPresent(play.modules.crud.annotations.Exclude.class)) {
                    type = null;
                }
